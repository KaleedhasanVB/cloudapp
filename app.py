...
your_postgres_server = "kdserver1.postgres.database.azure.com"
your_postgres_username = "kalee"
your_postgres_password = "arun4500#"
your_postgres_dbname = "db1"
connection_string = f"postgresql+psycopg2://{your_postgres_username}:{your_postgres_password}@{your_postgres_server}:5432/{your_postgres_dbname}"
# Create the engine
